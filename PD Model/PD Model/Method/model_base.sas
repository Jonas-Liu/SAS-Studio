...
%let DEL_var = CLTV cscore_b Curr_rte dti gdp_annual_rate hs qdt_ump ratio_upb;
...
%let d_pd = DEL;
ods listing;
proc print data=c1_del(obs = 10);run;
...
options nodate;
ods powerpoint file = "&p_report/model_del.ppt"
               style = Sapphire;
